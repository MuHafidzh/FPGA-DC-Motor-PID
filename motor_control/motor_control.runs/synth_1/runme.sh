...
HD_PWD='E:/kepston_bismillah_kebut/motor_control/motor_control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_motor_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_motor_control.tcl
