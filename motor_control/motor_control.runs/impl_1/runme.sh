...
HD_PWD='E:/kepston_bismillah_kebut/motor_control/motor_control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_motor_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_motor_control.tcl -notrace
